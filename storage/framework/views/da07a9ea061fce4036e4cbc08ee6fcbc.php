<?php $__env->startSection('title', 'Themes'); ?>
<?php $__env->startSection('styles'); ?>
  <link rel="stylesheet" href="<?php echo e(asset('css/themes.css')); ?>"> <!-- Themes page styles -->
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
<div id="themes-container" data-is-logged-in="<?php echo e(auth()->check() ? 'true' : 'false'); ?>">
    <!-- Contenu de ta page -->
</div>
    ...
    <div class="themes">
      ...
      <div class="bar" id="bar1">
        ...
        <form onsubmit="handleSubscribe(event)" data-theme-id="1">
            <?php echo csrf_field(); ?>
            <input type="image" id="subscribe-btn-1" src="<?php echo e(asset('images/subsc.png')); ?>" class="plus_btn">
        </form>
      </div>
      <hr>
      ...
      <div class="bar" id="bar2">
        ...
        <form onsubmit="handleSubscribe(event)" data-theme-id="2">
            <?php echo csrf_field(); ?>
            <input type="image" id="subscribe-btn-2" src="<?php echo e(asset('images/subsc.png')); ?>" class="plus_btn">
        </form>
      </div>
      <hr>
      ...
      <div class="bar" id="bar3">
        ...
        <form onsubmit="handleSubscribe(event)" data-theme-id="3">
            <?php echo csrf_field(); ?>
            <input type="image" id="subscribe-btn-3" src="<?php echo e(asset('images/subsc.png')); ?>" class="plus_btn">
        </form>
      </div>
      <hr>
      ...
      <div class="bar" id="bar4">
        ...
        <form onsubmit="handleSubscribe(event)" data-theme-id="4">
            <?php echo csrf_field(); ?>
            <input type="image" id="subscribe-btn-4" src="<?php echo e(asset('images/subsc.png')); ?>" class="plus_btn">
        </form>
      </div>
    </div>
  </div>
...
function handleSubscribe(event) {
    ...
    if (!isLoggedIn) {
        ...
        button.src = "<?php echo e(asset('images/check-mark.png')); ?>"; // Remplacez par le nouveau chemin de l'image
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.guestViews', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Elitebook\Desktop\TechRorizons\resources\views/themes.blade.php ENDPATH**/ ?>