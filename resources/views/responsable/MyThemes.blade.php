                    ...
                    <li>
                        <div class="bar">
                            ...
                            <div class="icon-container">
                                ...
                                <a href="{{ route('themes.statistics', $theme->id) }}" class="icon-btn" title="Voir les statistiques">
                                    <img src="{{ asset('images/diagram.png') }}" alt="Créer un article">
                                    <span class="hover-text">Voir les statistiques</span>
                                </a>
                                <a href="{{ route('themes.articles_status', $theme->id) }}" class="icon-btn" title="Voir les notifications des articles">
                                    <img src="{{ asset('images/notification.png') }}" alt="Créer un article">
