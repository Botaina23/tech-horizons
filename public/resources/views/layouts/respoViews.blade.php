...
<body>
    ...
    <a href="{{ route('subscribed.articles') }}">
        <img src="{{ asset('images/Explore.png') }}" alt="Explore" width="20" height="20"> Explore
    </a>
    <a href="{{ route('allathemeRespo') }}">
        <img src="{{ asset('images/book.png') }}" alt="Themes" width="20" height="20"> All themes
    </a>
    <a href="{{ route('history.index') }}">
        <img src="{{ asset('images/file.png') }}" alt="History" width="20" height="20"> History
    </a>
    <a href="{{ route('user.articles') }}">
        <img src="{{ asset('images/MyArticles.png') }}" alt="History" width="20" height="20"> My articles
    </a>

    
    <div class="bottom-links">
    <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
        <img src="{{ asset('images/user.png') }}" alt="User" width="20" height="20"> {{ Auth::user()->name }}
    </a>
    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
        <a class="dropdown-item" href="{{ route('logout') }}"
           onclick="event.preventDefault();
                    document.getElementById('logout-form').submit();">
            <img src="{{ asset('images/log-out.png') }}" alt="Logout" width="20" height="20"> {{ __('Logout') }}
        </a>
